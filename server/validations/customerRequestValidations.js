...
exports.customerRequestValidator = async function (data, user_id) {
  try {
    ...
    data.pickupLocation = !isEmpty(data.pickupLocation) ? data.pickupLocation : "";
    data.dropoffLocation = !isEmpty(data.dropoffLocation) ? data.dropoffLocation : "";
    data.packageDetails = !isEmpty(data.packageDetails) ? data.packageDetails : "";
    ...
    if (isEmpty(data)) {
      ...
      if (!isEmpty(data.packageDetails.weight) && typeof data.packageDetails.weight !== "number") {
      ...
      if (!isEmpty(data.packageDetails.dimensions)) {
        ...
        if ([length, width, height].some((v) => v !== undefined && typeof v !== "number")) {
          errors.packageDetails = {
            ...(errors.packageDetails || {}),
