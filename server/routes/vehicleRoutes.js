...
router.get('/my-vehicles', setAccessControl("*"), vehicleController.getMyVehicles);
...
router.patch('/status/:vehicleId', setAccessControl('*'), vehicleController.updateVehicleStatus);
